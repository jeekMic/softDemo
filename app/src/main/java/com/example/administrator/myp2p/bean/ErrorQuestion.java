...
@Entity
public class CollectQuestion implements Parcelable {
    ...
    protected CollectQuestion(Parcel in) {
        id = in.readString();
        title = in.readString();
        itype = in.readInt();
        rank = in.readString();
    ...
    public static final Creator<CollectQuestion> CREATOR = new Creator<CollectQuestion>() {
        @Override
        public CollectQuestion createFromParcel(Parcel in) {
            return new CollectQuestion(in);
        }

        @Override
        public CollectQuestion[] newArray(int size) {
            return new CollectQuestion[size];
        }
    };
    ...
    @Generated(hash = 145347719)
    public CollectQuestion(String id, String title, int itype, String rank, String classid, String courseid, String courseid2, String answers, String keys, String explain, String score, boolean is_en, boolean status,
            String select) {
        this.id = id;
        this.title = title;
        this.itype = itype;
